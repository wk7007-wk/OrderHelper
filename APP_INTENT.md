...
- 하루사용량은 수동값이 우선 기준이 아니다. 기본 공식은 `이전 남은재고 + 실발주 입고량 - 다음 남은재고 = 실사용량`이며, 수동값은 데이터가 부족할 때의 fallback/사전값이다.
...
- 전달: 웹 URL 반영 확인
- 최신 기준: `20260616-1` / 실사용량은 재고스냅샷+실발주 입고량 기준 / 라이브 `https://wk7007-wk.github.io/OrderHelper/`
