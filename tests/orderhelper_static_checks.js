...
assert.match(html, /CLI-OK-0831B/);
assert.match(html, /id="appVer"><\/span>\s*<span class="ux2-chip" id="ux2Chip"[^>]*>CLI-OK-0831B<\/span>/);
assert.match(html, /chip\.hidden = gridSortMode !== 'sfa'/);
